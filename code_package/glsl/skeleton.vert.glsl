...
//in ivec2 vs_InfluencerID;
//Note: Since there are some problems if I use ivec2 to read ID, I choose to use vec2
...
const vec4 lightPos = vec4(5, 5, 6, 1); //The position of our virtual light, which is used to compute the shading of
...
void main()
{
    ...
    fs_Nor = vec4(invTranspose * vec3(vs_Nor), 0);          // Pass the vertex normals to the fragment shader for interpolation.
                                                               ...
                                                               // the model matrix.
//    vec4 temp = vs_Weights[0] * u_JointTransformation[vs_InfluencerID[0]] * u_BindMatrices[vs_InfluencerID[0]] * vs_Pos
//            + vs_Weights[1] * u_JointTransformation[vs_InfluencerID[1]] * u_BindMatrices[vs_InfluencerID[1]] * vs_Pos;
