...
protected:
    ...
    GLuint bufInfluence_ID;
    GLuint bufVertex_Weights;

    bool idxBound; // Set to TRUE by generateIdx(), returned by bindIdx().
    bool posBound;
    bool norBound;
    bool colBound;
    bool Influence_ID_Bound;
    bool Vertex_Weights_Bound;
...
public:
    ...
    void generateInfluence_ID();
    void generateVertex_Weight();
    ...
    bool bindNor();
    bool bindCol();
    bool bindInfluence_ID();
    bool bindVertex_Weight();
};
